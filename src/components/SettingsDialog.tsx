...
export const SettingsDialog = ({ isOpen, onClose }: SettingsDialogProps) => {
  const { enabledProviders, apiKeys, toggleProvider, setApiKey } = useSettingsStore();
        ...
        <div className="p-6 max-h-[60vh] overflow-y-auto">
          ...
          {activeTab === 'keys' && (
            <div className="space-y-6">
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                Add your own API keys to enable these services. Keys are stored locally in your browser.
              </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-400">
                  Required for Last.fm search. <a href="https://www.last.fm/api/account/create" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Get key</a>
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-400">
                  Required for Discogs search. <a href="https://www.discogs.com/settings/developers" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Get token</a>
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-400">
                  Required for AI enhancements. <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Get key</a>
                </p>
              </div>
            </div>
          )}
