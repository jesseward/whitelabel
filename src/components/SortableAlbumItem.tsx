...
export const SortableAlbumItem = memo(({ album, onRemove }: SortableAlbumItemProps) => {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="text-xs font-black truncate text-gray-800 dark:text-gray-100 leading-none mb-1">{album.album}</p>
        <p className="text-[10px] text-gray-500 dark:text-gray-400 truncate font-bold uppercase tracking-tight">{album.artist}</p>
      </div>
