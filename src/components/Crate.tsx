  ...
  return (
    <aside className="bg-white dark:bg-gray-900 p-6 rounded-2xl h-fit sticky top-8 border border-gray-200 dark:border-gray-800 shadow-xl overflow-hidden">
          ...
          {selectedAlbums.length > 1 && (
            ...
            >
              <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M4 4h7m-7 8h3m10-8h-7l-3.5 10M16 12h5m-5 8h5" />
              </svg>
              Shuffle
            </button>
          )}
      ...
      {selectedAlbums.length === 0 ? (
        ...
        >
          <p className="text-gray-400 dark:text-gray-500 text-sm italic font-medium">Add some albums to start building your masterpiece.</p>
        </motion.div>
      ) : (
        <DndContext
          sensors={sensors}
